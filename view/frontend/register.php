...
<!-- connexion form --> 
   ...
   <div class="registration_form_container">
      ...
      <br>
      <label>Confirmer votre mail</label> <input class="registration_form_input_mail" type="mail" placeholder="adresse mail *" name="confirmMail">
      <span> <?= $user->confirmMailError() ?></span>
      <br>
      <div class="registration_form_container_input_password">
        <label>Votre prénom</label> <input class="registration_form_input_password"type="text" placeholder="votre prénom *" name="name">
        <span> <?= $user->nameError() ?></span>
        <br>
      </div>
      <div class="registration_form_container_input_password">
        <label>Votre nom</label> <input class="registration_form_input_password"type="text" placeholder="votre nom *" name="lastName">
