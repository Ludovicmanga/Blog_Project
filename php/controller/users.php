...
class Users
{
	...
	public function register()
	{
		...
		if($_SERVER['REQUEST_METHOD'] == 'POST') 
		{
			...
			$user->nameError(trim($_POST['nameError'])); 
			$user->lastName(trim($_POST['lastName'])); 
			$user->lastNameError(trim($_POST['lastNameError'])); 
			$user->mail(trim($_POST['mail'])); 
			$user->mailError(trim($_POST['mailError']));
			$user->confirmMail(trim($_POST['confirmMail'])); 
			$user->confirmMailError(trim($_POST['confirmMailError'])); 
			$user->password(trim($_POST['password'])); 
			$user->passwordError(trim($_POST['passwordError'])); 
			$user->confirmPassword(trim($_POST['confirmPassword'])); 
			$user->confirmPasswordError(trim($_POST['confirmPasswordError'])); 
