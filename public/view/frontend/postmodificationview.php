...
<body>
  ...
  <div class="container">
    ...
    <div class="post_modification_form_container">
      ...
      <form action="index.php?action=messagesent" method = "POST" class="post_modification_form">
      <label>Titre article</label> <input class= "post_modification_form_input_post_title" type="text" value="<?= $post['title'];?>"></input><br>
      <label>Sous-titre article</label> <input class="post_modification_form_input_post_subtitle"type="text" value="<?= $post['subtitle'];?>"></input><br>
      <label>Sujet article</label> <input class="post_modification_form_input_post_topic" type="mail" value="<?= $post['topic'];?>"></input><br>
      <div class="post_form_container_textarea">
        <div>
          <label>Contenu article</label>
        </div>
        <div>
            <textarea class="post_modification_form_textarea_content">
              <?= $post['content'];  ?>
            </textarea><br>
        </div>
      </div>
